...
[Download](https://github.com/Swift-Simplified/ss-classes-structs-enums/archive/refs/heads/main.zip) this Swift playground file to run the example given in [Xcode](https://developer.apple.com/xcode).
